<template>
    <svg
        ...
        y="0px"
        width="100%"
        viewBox="0 0 79.1 80.8"
        style="enable-background: new 0 0 284.9 80.8; fill: currentColor"
        xml:space="preserve"
    >
        <path
            d="M32,55.3c0.3,1.4,0.6,2.7,1,3.9c0,0,0,0,0.1,0c1.1,0,2.1,0.9,2.1,2.1c0,0.6-0.3,1.2-0.8,1.6c1.6,3.5,3.4,5.4,5.3,5.4
	c2.9,0,6-5,7.7-13.3c-2.4-0.8-4.9-1.9-7.4-3.1C37.2,53.3,34.6,54.4,32,55.3"
        />
        <path
            d="M34.5,49.1c-1.2-0.7-2.5-1.5-3.7-2.3c0.2,2.6,0.5,4.9,0.9,7.1c2.1-0.8,4.3-1.7,6.6-2.7C37.1,50.5,35.8,49.8,34.5,49.1"
        />
        <path
            d="M45,31c1.2,0.7,2.3,1.4,3.5,2.1c-0.2-2.3-0.5-4.5-0.9-6.5c-2,0.7-4,1.5-6.1,2.5C42.6,29.7,43.8,30.3,45,31"
        />
        <path
            d="M24.8,25.7c-1,0-1.8-0.7-2-1.6c-0.8-0.1-1.5-0.1-2.1-0.1c-2.7,0-4.5,0.7-5.3,2c-1.4,2.5,1.3,7.6,7.6,13.2
	c2-1.7,4.1-3.3,6.4-4.9c0.2-2.9,0.6-5.8,1.1-8.4c-1.4-0.4-2.7-0.8-4-1.1C26.2,25.4,25.5,25.7,24.8,25.7"
        />
        <path
            d="M41.5,51.2c2.1,1,4.2,1.8,6.1,2.5c0.4-2,0.7-4.2,0.9-6.6c-1.2,0.8-2.4,1.5-3.6,2.2C43.7,50,42.6,50.6,41.5,51.2"
        />
        <path
            d="M47.3,25.2c-0.3-1.6-0.7-3.1-1.2-4.5c-1.1-0.1-2-1-2-2.1c0-0.6,0.2-1.1,0.6-1.4c-1.5-3.2-3.3-5-5.1-5
	c-2.9,0-5.9,4.8-7.6,12.8c2.5,0.9,5.2,2,7.8,3.3C42.4,27.1,44.9,26,47.3,25.2"
        />
        <path
            d="M24,40.1c1.6,1.3,3.3,2.7,5.3,4c-0.1-1.3-0.1-2.6-0.1-3.9c0-1.4,0-2.8,0.1-4.2C27.4,37.4,25.6,38.8,24,40.1"
        />
        <path
            d="M38.3,29.1c-2.2-1.1-4.4-2-6.6-2.7c-0.4,2.1-0.7,4.5-0.9,7c1.2-0.8,2.4-1.5,3.6-2.2C35.7,30.5,37,29.7,38.3,29.1"
        />
        <path
            d="M23,41c-1.1,1-2.2,2-3.1,3c0.2,0.3,0.3,0.7,0.3,1c0,1.1-0.9,2.1-2.1,2.1c-0.2,0-0.5,0-0.7-0.1c-2.3,3.1-3,5.7-2.1,7.3
	c1.1,2,4.8,2.5,10,1.4c1.6-0.3,3.3-0.8,5.1-1.4c-0.5-2.7-0.9-5.6-1.1-8.5C27.1,44.3,25,42.7,23,41"
        />
        <path
            d="M36.9,45.2c0,0.6,1,1.4,2.5,1.6c0,0,0,0,0,0v-3.1C38.2,43.8,36.9,44.5,36.9,45.2"
        />
        <path
            d="M55.6,40.1c-1.7-1.4-3.5-2.9-5.6-4.3c0.1,1.5,0.1,3,0.1,4.4c0,1.4,0,2.8-0.1,4.2C52.1,43,54,41.5,55.6,40.1"
        />
        <path
            d="M56.6,41c-2,1.8-4.3,3.5-6.7,5.1c-0.2,2.8-0.5,5.5-1,8c1.5,0.5,3,0.9,4.5,1.2c0.3-0.7,1-1.1,1.8-1.1c1,0,1.9,0.7,2,1.7
	c3.5,0.3,5.9-0.4,6.8-1.9C65.5,51.6,62.8,46.6,56.6,41"
        />
        <path
            d="M58.8,57.4c-0.6,0-1.1,0-1.7-0.1c-0.4,0.6-1,1.1-1.8,1.1c-1,0-1.8-0.7-2-1.7c-1.5-0.3-3-0.7-4.5-1.2
	...
	c0,17.5,14.2,31.6,31.6,31.6s31.6-14.2,31.6-31.6C71.3,22.8,57.1,8.6,39.7,8.6"
        />
        <path
            d="M56.6,39.2c1.2-1.1,2.3-2.2,3.3-3.3c-0.2-0.3-0.3-0.7-0.3-1.1c0-1.1,0.9-2.1,2.1-2.1c0.2,0,0.4,0,0.6,0.1
	...
	C52.3,35.7,54.6,37.5,56.6,39.2"
        />
        <path
            d="M36.5,40.9c0,0.7,1.4,1.6,2.9,1.8v-3.5C37.9,39.4,36.5,40.2,36.5,40.9"
        />
        <path
            d="M44.9,40.9c0,0.9-0.9,1.8-2.4,2.3c1.2,0.4,2,1.2,2,2c0,0.9-0.8,1.6-2.1,2.1c-0.2,0.1-1,0.3-1.7,0.3c0,0,0,0,0,0c0,0,0,0,0,0
	...
	c1.5-0.9,3-1.8,4.4-2.7c0.1-1.6,0.2-3.4,0.2-5.1c0-1.9-0.1-3.7-0.2-5.4C47.2,34,45.8,33.1,44.3,32.2"
        />
        <path
            d="M40.5,42.7c1.5-0.2,2.9-1,2.9-1.8c0-0.7-1.4-1.6-2.9-1.8V42.7z"
        />
        <path
            d="M40.5,46.8C40.5,46.8,40.5,46.8,40.5,46.8c1.2-0.2,2.5-0.9,2.5-1.6c0-0.7-1.3-1.4-2.5-1.6V46.8z"
        />
        <path
            d="M6,26.7c0.3,0.1,0.6,0,0.7-0.3c0.1-0.3,0-0.6-0.3-0.6c-0.2-0.1-0.5,0-0.6,0.3C5.7,26.3,5.8,26.6,6,26.7 M3.5,33.8
