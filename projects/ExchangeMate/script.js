    ...
    function myClickHandler(){
        ...
        for (var i = 0; i < selection.length; i++) {
            ...
            if (item.row != null) {
                ...
                modalT = "Overall score of <img src='https://flagcdn.com/16x12/" + code + ".png'> " + c + ": <b style='color: blue'>" + valueToString(data.getFormattedValue(item.row, 1)) + "</b> (" + data.getFormattedValue(item.row, 1) + "%)"
...
function showRanking() {
    ...
    for(var i = 0; i < temp.length; i++) {
        ...
        td1.innerHTML = '<img src="https://flagcdn.com/16x12/' + code + '.png"> ' + temp[i][0]
